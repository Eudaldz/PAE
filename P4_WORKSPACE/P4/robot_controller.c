...
void stop(){
    sendPacket(moveActuatorPacket(leftActuator, 0, LEFT_FORWARD));
    sendPacket(moveActuatorPacket(rightActuator, 0, RIGHT_FORWARD));
}
